...
namespace WatchDogCompleteTestAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddWatchDogServices(opt => { opt.IsAutoClear = false; opt.SetExternalDbConnString = "Server=tyke.db.elephantsql.com;Database=yfdvduiw;User Id=yfdvduiw;Password=7hkiF-hmiXfF_vbPcFPGg7j_FeA0kKiy;"; opt.SqlDriverOption = WatchDogSqlDriverEnum.PostgreSql; });
